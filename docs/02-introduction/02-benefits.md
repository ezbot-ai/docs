...
- **In-code**: Developers can use our JS Browser SDK or [REST API](/reference-materials/REST-api) to integrate ezbot’s powerful optimization engine directly into their stack.
